...
import { ethers } from 'ethers' // Keep ethers for isAddress check if needed, or remove if API handles validation
...
export default function TreasuryPage() {
    ...
    return (
        <div className="max-w-3xl mx-auto">
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-gray-900">Configuración de Tesorería</h1>
                <p className="text-gray-500">Gestionar la cuenta receptora de penalizaciones.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h2 className="text-lg font-bold text-gray-900">Tesorería Actual</h2>
                        <p className="text-gray-500 text-sm mb-4">Esta cuenta recibe todos los tokens cobrados por penalizaciones de inactividad.</p>

                        {loading ? (
                            <div className="animate-pulse h-8 w-64 bg-gray-200 rounded"></div>
                        ) : (
                            <div className="space-y-2">
                                <div className="font-mono bg-gray-50 px-4 py-2 rounded-lg border border-gray-200 text-gray-700 break-all">
                                    {currentTreasury}
                                </div>
