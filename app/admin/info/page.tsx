...
import { Sun, Moon, Wallet, Clock, AlertCircle } from 'lucide-react'
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                {/* GAS Card */}
                <RainbowCard className="h-full row-span-2" isDarkMode={isDarkMode}>
                    <div className={`flex flex-col items-center text-center h-full ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                        ...
                        <h2 className="text-3xl font-bold mb-8">GAS (Sepolia ETH)</h2>
                        ...
                        <div className="flex items-center gap-4 mb-8">
                            <div className={`w-32 h-32 rounded-3xl border-2 border-black flex items-center justify-center p-4 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                                <span className="text-lg font-bold break-all">
                                    {parseFloat(stats.adminEthBalance).toFixed(4)}
                                </span>
                            </div>
                            <div className="text-left">
                                <p className="text-xl font-bold">Balance para</p>
                                <p className="text-xl font-bold">Transaccion</p>
                            </div>
                        </div>
                ...
                {/* Periodo Inactividad Card */}
                <RainbowCard className="h-full" isDarkMode={isDarkMode}>
                    <div className={`flex flex-col items-center text-center h-full ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                        <div className="relative mb-6">
                            <div className={`w-20 h-20 rounded-full border-2 border-black flex items-center justify-center ${isDarkMode ? 'bg-gray-800' : 'bg-white'} z-10 relative overflow-hidden`}>
                                <Image src="/lionlogo-transparent.png" alt="Lion Logo" width={70} height={70} className="object-contain" />
                            </div>
                            <div className={`absolute -top-2 -right-10 w-14 h-14 rounded-full border-2 border-black flex items-center justify-center ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                                <Clock size={28} className="text-orange-600" />
                            </div>
                        </div>

                        <h2 className="text-2xl font-bold mb-4">Periodo Inactividad</h2>

                        <div className="flex items-center gap-4">
                            <div className={`w-24 h-24 rounded-3xl border-2 border-black flex items-center justify-center p-2 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                                <span className="text-lg font-bold">
                                    {stats.inactivityPeriod} Dias
                                </span>
                            </div>
                            <div className="text-left">
                                <p className="text-lg font-bold">Tiempo</p>
                                <p className="text-lg font-bold">Limite</p>
                                <p className="text-sm font-bold mt-1">PRX</p>
                            </div>
                        </div>
                    </div>
                </RainbowCard>

                {/* Tasa Penalizacion Card */}
                <RainbowCard className="h-full" isDarkMode={isDarkMode}>
                    <div className={`flex flex-col items-center text-center h-full ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                        <div className="relative mb-6">
                            <div className={`w-20 h-20 rounded-full border-2 border-black flex items-center justify-center ${isDarkMode ? 'bg-gray-800' : 'bg-white'} z-10 relative overflow-hidden`}>
                        ...
                        <h2 className="text-2xl font-bold mb-4">Tasa Penalizacion</h2>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="text-left">
                                <p className="text-lg font-bold">1 Mes</p>
                                <p className="text-lg font-bold">de</p>
                                <p className="text-lg font-bold">Inactividad</p>
                                <p className="text-sm font-bold mt-1">PRX</p>
                            </div>
                        </div>
                    </div>
